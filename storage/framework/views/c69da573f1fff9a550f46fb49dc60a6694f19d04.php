...
<section class="trending-product" id="trending">
    ...
    <div class="products">
        <div class="row"> <!-- 1 -->
            <a href="/oneitemlogged"><img src="./LoakPedia/Logged/1.jpg" alt=""></a>
        ...
        <div class="row"> <!-- 2 -->
            <img src="./LoakPedia/Logged/2.jpg" alt="">
            <div class="product-text">
                <h5>New</h5>
            </div>
            <div class="heart-icon">
        ...
        <div class="row"> <!-- 4 -->
            <img src="./LoakPedia/Logged/4.jpg" alt="">
            <div class="product-text">
                <h5>Hot</h5>
            </div>
            <div class="heart-icon">
        ...
        <div class="row"> <!-- 5 -->
            <img src="./LoakPedia/Logged/5.jpg" alt="">
        ...
        <div class="row"> <!-- 6 -->
            <img src="./LoakPedia/Logged/6.jpg" alt="">
            <div class="product-text">
                <h5>Hot</h5>
            </div>
            <div class="heart-icon">
