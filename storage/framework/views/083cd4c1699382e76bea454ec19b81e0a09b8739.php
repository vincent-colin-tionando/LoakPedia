        ...
        <div class="row"> <!-- 1. Men Fashion -->
            ...
            <div class="con-text">
                ...
                <p>
                    ...
                    <a href="Produk_MenFashion.html">Tampilkan lebih</a>
                </p>
            </div>
        </div>
...
<?php echo $__env->make('layouts.frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Aldd\A sunib\SEMESTER 4\SE\Code\LoakPedia\Laravel\LoakPedia\resources\views/pages/product.blade.php ENDPATH**/ ?>