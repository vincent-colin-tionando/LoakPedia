...
<head>
    ...
    <title>Home - LoakPedia</title>
    <link rel="stylesheet" href="./LoakPedia/Project_home.css">
...
<body>
    <nav>
        <div class="header">
            <a href="Project_Home.html"><img src="./LoakPedia/nadiaArtboard 1.png" alt="LoakPedia"></a>
            <!-- nadiaArtboard 1.png -->
            <div class="menu">
                <!-- kategori -->
                ...
                <ul class="menu-links">
                    ...
                    <ul class="navigation">
                        ...
                        <li><a href="/login"><i class='bx bx-bell'>Notifikasi</i></a></li>
                        <li><a href="/login"><i class='bx bxs-bookmarks'>Favorit</i></a></li>
                        <li><a href="/login"><i class='bx bx-cart'>Belanja</i></a></li>
                        <li><a href="/login"><i class='bx bx-store-alt'>Toko</i></a></li>
                    </ul>
                    <ul class="login-btn">
                        <li><a href="/login"><button class="login-popup">Login</button></a></li>
                    </ul>
                </ul>
            </div>
        </div>
...
<?php /**PATH E:\Aldd\A sunib\SEMESTER 4\SE\Code\LoakPedia\Laravel\LoakPedia\resources\views/layouts/frontend/master.blade.php ENDPATH**/ ?>